...
<body>
    <h6>SISTEM PENGURUSAN PENYEMBUR PEMBERSIH BADAN AUTOMATIK
    </h6>
    <h6>BERASASKAN IOT</h6>


    <div class="container">
        <div class="screen">
            <div class="screen__content">
                <form method="post" action="insertAdmin.php" class="login">
                    ...
                    <button class="button login__submit">
                        <span type="submit" class="button__text">Daftar</span>
